...
/**
 * The class implementing method "array sort bubble"
 */
public class ArraySortBubble implements Command {
    private static Logger logger = LogManager.getLogger(ArraySortBubble.class);
