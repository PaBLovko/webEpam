 ...
 */
public class MatrixServiceAction {
    private static Logger logger = LogManager.getLogger(MatrixServiceAction.class);
    ...
    public Matrix<Integer> matrixMultiply(@NonNull final Matrix<Integer> first, @NonNull final Matrix<Integer> second)
        ...
        try {
            ...
            logger.error("The method is exception, variable overflow when multiplying matrices");
            throw new ServiceException("variable overflow when multiplying matrices",e);
        }
    ...
    public Matrix<Integer> matrixSummation(@NonNull final Matrix<Integer> first, @NonNull final Matrix<Integer> second)
        ...
        try {
            ...
            logger.error("The method is exception, variable overflow when summing the matrix");
            throw new ServiceException("variable overflow when summing the matrix",e);
        }
        logger.info(String.format(METHOD_WORKED_CORRECTLY, result));
        return result;
    }
