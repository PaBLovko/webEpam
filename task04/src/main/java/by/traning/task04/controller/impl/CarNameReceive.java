...
/**
 * The class implementing method "car name receive"
 */
public class CarNameReceive implements Command {
    private static Logger logger = LogManager.getLogger(CarNameReceive.class);
    ...
    public String execute(String request) {
        ...
        try {
            ...
            response = carService.nameReceive(modelName);
