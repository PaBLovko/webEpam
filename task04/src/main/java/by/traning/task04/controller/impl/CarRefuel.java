...
import by.traning.task04.MessageManager;
...
/**
 * The class implementing method "car refuel"
 */
public class CarRefuel implements Command {
    private static Logger logger = LogManager.getLogger(CarRefuel.class);
