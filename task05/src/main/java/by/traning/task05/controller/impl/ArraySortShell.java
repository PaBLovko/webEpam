...
/**
 * The class implementing method "array sort shell"
 */
public class ArraySortShell implements Command {
    private static Logger logger = LogManager.getLogger(ArraySortShell.class);
