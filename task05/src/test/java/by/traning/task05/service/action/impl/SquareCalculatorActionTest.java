...
public class SquareCalculatorActionTest {

    private final SquareCalculatorAction square = new SquareCalculatorAction();
    ...
    public void resultingFigureNameTest(String expected){
        String actual = square.resultingFigureName();
    ...
    public void areaCalculatorTest(Quadrilateral a, double expected){
        double actual = square.areaCalculator(a);
    ...
    public void perimeterCalculatorTest(Quadrilateral a, double expected){
        double actual = square.perimeterCalculator(a);
        Assert.assertEquals(actual,expected,DELTA);
    }
}
