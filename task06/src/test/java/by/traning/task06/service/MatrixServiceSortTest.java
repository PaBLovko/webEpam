...
import by.traning.task06.service.sort.MatrixServiceSort;
...
public class MatrixServiceSortTest {
    private final MatrixServiceSort matrixServiceAction = new MatrixServiceSort();
    ...
    public Object[][] createCorrectDataForSubtraction() {
        return
                new Object[][]{
                        ...
                        {new Matrix[]{new Matrix<>(new Integer[][]{{5}}),
                                new Matrix<>(new Integer[][]{{5}})},
                                new Matrix<>(new Integer[][]{{0}})}
                };
    }
